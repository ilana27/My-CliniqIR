...
public class PubmedSearcher2 {


private PubmedSearcher2() {}
 ...
 PrintStream fileStream = new PrintStream("Query_Results.txt");
 
   System.setOut(fileStream);
   
   
String index = "Pubmed_Index";
...
//   String[] fields = {"abstractText", "articleTitle"};
   String[] fields = {"abstractText"};
 ...
 //  QueryParser parser = new QueryParser("<default field>", analyzer);
   ...
   while (true) {
    ...
    // System.out.println("Searching for: " + query.toString(queryString));
     System.out.println("QueryID" + "\t"+ "PMID" +"\t"+ "ABSTRACT" +"\t"+ "SCORE"+"\t"+ "CONCEPTS");
